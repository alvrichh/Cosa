...
public class InicializarDatos implements CommandLineRunner {
	 ...
	 private Usuario crearOBuscarUsuario(String username, String password, RolUsuario rol) {
	     return usuarioRepository.findByUsername(username).orElseGet(() -> {
	         ...
	         nuevoPerfil.setNombre(faker.name().firstName());
	         nuevoPerfil.setApellido(faker.name().lastName());
	         nuevoPerfil.setEmail(faker.internet().emailAddress());  
	         
	         nuevoUsuario.setPerfilUsuario(nuevoPerfil);
